...
namespace BH.Upgraders
{
    ...
    public static class v50
    {
        ...
        [VersioningTarget("BH.oM.Revit.PinnedButtonInfo")]
        public static Dictionary<string, object> UpgradePinnedButtonInfo(Dictionary<string, object> oldVersion)
        {
        ...
        [VersioningTarget("BH.oM.Adapters.Revit.Elements.ModelInstance")]
        public static Dictionary<string, object> UpgradeModelInstance(Dictionary<string, object> oldVersion)
        {
            if (oldVersion == null)
                return null;
