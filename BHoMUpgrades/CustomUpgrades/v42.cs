...
namespace BH.Upgraders
{
    ...
    public static class v42
    {
        ...
        [VersioningTarget("BH.oM.Adapters.RAM.UniformLoadSet")]
        ...
        [VersioningTarget("BH.oM.CFD.CFX.AutoTimescale")]
        public static Dictionary<string, object> UpgradeAutoTimescale(Dictionary<string, object> oldVersion)
        {
            if (oldVersion == null)
                return null;
        ...
        [VersioningTarget("BH.oM.LifeCycleAssessment.MaterialFragment.EnvironmentalProductDeclaration")]
        public static Dictionary<string, object> UpgradeEnvironmentalProductDeclaration(Dictionary<string, object> oldVersion)
        {
            if (oldVersion == null)
                return null;
