...
{
    [Upgrader(7, 0)]
    public static class v70
    {
        /***************************************************/
        /**** Public Methods                            ****/
        /***************************************************/

        [VersioningTarget("BH.oM.LadybugTools.Shelter")]
        ...
        [VersioningTarget("BH.oM.LadybugTools.OpaqueMaterial")]
        [VersioningTarget("BH.oM.LadybugTools.OpaqueVegetationMaterial")]
        [VersioningTarget("BH.oM.LadybugTools.ILadybugToolsMaterial")]
        public static Dictionary<string, object> UpgradeILadybugToolsMaterial(Dictionary<string, object> oldVersion)
        {
            Dictionary<string, object> newVersion = new Dictionary<string, object>(oldVersion);
        ...
        [VersioningTarget("BH.oM.LadybugTools.ExternalComfort")]
        public static Dictionary<string, object> UpgradeExternalComfort(Dictionary<string, object> oldVersion)
        {
            Dictionary<string, object> newVersion = new Dictionary<string, object>(oldVersion);
