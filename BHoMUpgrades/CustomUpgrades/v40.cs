...
namespace BH.Upgraders
{
    ...
    public static class v40
    {
        ...
        [VersioningTarget("BH.oM.MEP.System.SectionProperties.WireSectionProperty")]
        [VersioningTarget("BH.oM.MEP.SectionProperties.WireSectionProperty")]
        public static Dictionary<string, object> UpgradeWireSectionProperty(Dictionary<string, object> oldVersion)
        {
            if (oldVersion == null)
                return null;
        ...
        [VersioningTarget("BH.oM.MEP.System.SectionProperties.PipeSectionProperty")]
        [VersioningTarget("BH.oM.MEP.SectionProperties.PipeSectionProperty")]
        public static Dictionary<string, object> UpgradePipeSectionProperty(Dictionary<string, object> oldVersion)
        {
            if (oldVersion == null)
                return null;
        ...
        [VersioningTarget("BH.oM.MEP.System.SectionProperties.DuctSectionProperty")]
        [VersioningTarget("BH.oM.MEP.SectionProperties.DuctSectionProperty")]
        public static Dictionary<string, object> UpgradeDuctSectionProperty(Dictionary<string, object> oldVersion)
        {
            if (oldVersion == null)
                return null;
        ...
        private static Dictionary<string, object> ConvertIMEPMaterialToPhysicalMaterial(Dictionary<string, object> mepMaterial)
        {
            ...
            if (mepMaterial.ContainsKey("_t") && (mepMaterial["_t"] as string) == "BH.oM.Physical.Materials.Material")
                return mepMaterial; //Already a physical material, doesn't need converting
        ...
        [VersioningTarget("BH.oM.Geometry.BoundaryRepresentation")]
        ...
        [VersioningTarget("BH.oM.Geometry.ShapeProfiles.TaperedProfile")]
        ...
        [VersioningTarget("BH.oM.Environment.Gains.Profile")]
        ...
        [VersioningTarget("BH.oM.Environment.Elements.Space")]
        ...
        [VersioningTarget("BH.oM.Structure.MaterialFragments.Aluminium")]
        [VersioningTarget("BH.oM.Structure.MaterialFragments.Concrete")]
        [VersioningTarget("BH.oM.Structure.MaterialFragments.GenericIsotropicMaterial")]
        [VersioningTarget("BH.oM.Structure.MaterialFragments.GenericOrthotropicMaterial")]
        [VersioningTarget("BH.oM.Structure.MaterialFragments.IMaterialFragment")]
        [VersioningTarget("BH.oM.Structure.MaterialFragments.Steel")]
        [VersioningTarget("BH.oM.Structure.MaterialFragments.Timber")]
        ...
        [VersioningTarget("BH.oM.Adapters.Revit.FamilyLibrary")]
        ...
        [VersioningTarget("BH.oM.MEP.Elements.Node")]
        ...
        [VersioningTarget("BH.oM.Diffing.DiffConfig")]
        ...
        [VersioningTarget("BH.oM.Diffing.HashFragment")]
        ...
        [VersioningTarget("BH.oM.Adapters.Filing.PushConfig")]
        ...
        [VersioningTarget("BH.oM.Graphics.RenderMeshOptions")]
        ...
        [VersioningTarget("BH.oM.Adapters.Revit.Elements.ViewPlan")]
