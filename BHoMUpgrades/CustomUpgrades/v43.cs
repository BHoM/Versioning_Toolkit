...
namespace BH.Upgraders
{
    ...
    public static class v43
    {
        ...
        [VersioningTarget("BH.oM.Structure.SectionProperties.ConcreteSection")]
        ...
        [VersioningTarget("BH.oM.MEP.System.CableTray")]
        public static Dictionary<string, object> UpgradeCableTray(Dictionary<string, object> oldVersion)
        {
            if (oldVersion == null)
                return null;
